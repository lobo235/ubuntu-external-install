...
- Document that the ISO or mounted source is trusted code during privileged chroot finalization, and point users to Ubuntu's official ISO verification guidance before running a real install.
